...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'note' | 'chat' | 'library' | 'media'>('dashboard');
  const [previousView, setPreviousView] = useState<'dashboard' | 'library' | 'media'>('dashboard');
