...
import { BookOpenIcon, ChatBubbleOvalLeftEllipsisIcon, CalendarDaysIcon, CogIcon, PlusIcon } from './icons';
...
const BottomNavBar: React.FC<BottomNavBarProps> = ({ currentView, onSetView, onNewNote, onStartConversation }) => {
